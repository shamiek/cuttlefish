...
//    private static final String DEFAULT_PRIVATE_KEY_PATH = "/tmp/elgamal.sk";
    ...
    @Override
    public void keyGen() {
        System.out.println("ElGamal keys not found. Generating " + BITLENGTH +" length priv and pub keys for ElGamal");
    ...
    public static void main(String[] args) {
        ...
        long m = 1234876543;
        ElGamalCipher c = elgamal.encrypt(m);
        System.out.println(c);
        System.out.println(ElGamal.toBytes(c).length);
        System.out.println(elgamal.decrypt(c));
    }
...
class ElGamalCipher implements Serializable {
